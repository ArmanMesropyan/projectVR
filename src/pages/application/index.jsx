  ...
  return (
    <>
      <div className="default-container text-white dark:text-custom-purple ll:flex-wrap ll:justify-around">
        <div className="w-1/4 text-center bg-gradient-radial-to-tr rounded-3xl p-6 mx-3 dark:bg-gradient-radial-to-tr-white ll:m-5 l:w-2/6 l:mx-2 l:my-5 t:w-2/5 mt:w-full">
          <div
